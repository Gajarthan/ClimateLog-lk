...
Windows. The GitHub CI matrix validates Windows and Linux; consult the workflow run for the latest result.
...
threshold. Sustained production freshness remains a deployment check. Older internal parser/summary classes
...
See the [architecture and migration plan](superpowers/plans/2026-09-12-weather-architecture.md)
and [LICENSE](../LICENSE).
